...
class CustomerPostGet(APITestCase):
    def test_create_customer(self):
        ...
        print(Fore.GREEN + "3) Assert that we can create a new customer using a POST request")


        url = "http://127.0.0.1:8000/api/customers/"
        data = {"first_name": "Steven","last_name": "Jones", "email": "sjones@yahoo.com"}
        ...
        print(Fore.GREEN + "4) Assert that we can retrieve the newly created customer using a GET request")
        ...
        print(Fore.GREEN + "5) Assert that we can get a Customer by ID using a GET request")
        ...
        print(Fore.GREEN + "6) Assert that we can edit a Customer by ID using a PUT request")
